    ...
    <div className="space-y-6 animate-fade">
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-24 text-center gap-4">
          ...
          <p className="font-semibold text-on-surface text-lg">No events posted yet</p>
          <p className="text-sm text-outline max-w-xs">
            Check back soon — campus events will appear here once they are published by the admin.
          </p>
        </div>
      ) : (
